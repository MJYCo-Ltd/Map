...
void CMapLine::InitStyle()
{
    m_pNodeStyle->getOrCreate<osgEarth::LineSymbol>()
            ->stroke()->color().set(m_stLineColor.fR,m_stLineColor.fG
...
{
    m_pNodeStyle->getOrCreate<osgEarth::LineSymbol>()->stroke()->color().set(m_stLineColor.fR,m_stLineColor.fG,m_stLineColor.fB,m_stLineColor.fA);
}
