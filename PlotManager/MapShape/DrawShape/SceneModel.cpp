...
void CSceneModel::InitStyle()
{
    ...
    m_stylePic.getOrCreate<osgEarth::IconSymbol>()->alignment() = osgEarth::IconSymbol::ALIGN_CENTER_CENTER;
    m_stylePic.getOrCreate<osgEarth::IconSymbol>()->declutter() = false;
