...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterType<Simulation>("MyItem",1,0,"Simulation");
    qmlRegisterType<ProcessBuild>("MyItem",1,0,"ProcessBuild");
    qmlRegisterType<CommandBuildComponent>("MyItem",1,0,"CommandBuildComponent");
