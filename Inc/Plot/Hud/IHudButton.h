#ifndef INTERFACE_HUD_BUTTON_HEARDER_H
#define INTERFACE_HUD_BUTTON_HEARDER_H

#include <string>
#include <Hud/IHudNode.h>

class IHudButtonObserver
{
public:
    virtual ~IHudButtonObserver(){}
    virtual void ButtonOnClick(const class IHudButton*)=0;
};

/**
 * @brief 视口的屏显类
 */
class IHudButton:public IHudNode
{
public:
    CONSTRUCTOR(IHudButton,IHudNode)
     ...
     * @brief 订阅或取消观察者
     */
    virtual bool SubObserver(IHudButtonObserver* pObserver)=0;
    virtual bool UnSubObserver(IHudButtonObserver* pObserver)=0;
protected:
    virtual ~IHudButton(){}
...
#endif// INTERFACE_HUD_BUTTON_HEARDER_H
